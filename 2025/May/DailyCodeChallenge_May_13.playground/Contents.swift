...
print("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -")
let testsCases: [StaircaseInputData] = [
  (numberOfSteps: -1, stepsRange: []),
  (numberOfSteps: -1, stepsRange: [0]),
  (numberOfSteps: -1, stepsRange: [-1, 1]),
  (numberOfSteps: -1, stepsRange: [-2, 0]),
  (numberOfSteps: 0, stepsRange: []),
  (numberOfSteps: 0, stepsRange: [-1, 1]),
  (numberOfSteps: 0, stepsRange: [1, 2]),
  (numberOfSteps: 1, stepsRange: []),
  (numberOfSteps: 1, stepsRange: [0]),
  (numberOfSteps: 1, stepsRange: [1]),
  (numberOfSteps: 1, stepsRange: [1, 2]),
  (numberOfSteps: 2, stepsRange: [0]),
  (numberOfSteps: 2, stepsRange: [1]),
  (numberOfSteps: 2, stepsRange: [1, 2]),
  (numberOfSteps: 2, stepsRange: [0, -2]),
  (numberOfSteps: 3, stepsRange: [0]),
  (numberOfSteps: 3, stepsRange: [1]),
  (numberOfSteps: 3, stepsRange: [1, 2]),
  (numberOfSteps: 3, stepsRange: [0, -2]),
  (numberOfSteps: 3, stepsRange: [1, 2, 3]),
  (numberOfSteps: 4, stepsRange: [0]),
  (numberOfSteps: 4, stepsRange: [1]),
  (numberOfSteps: 4, stepsRange: [1, 2]),
  (numberOfSteps: 4, stepsRange: [0, -2]),
  (numberOfSteps: 4, stepsRange: [1, 2, 3]),
  (numberOfSteps: 4, stepsRange: [1, 2, 3, 4]),
  (numberOfSteps: 5, stepsRange: [0]),
  (numberOfSteps: 5, stepsRange: [1]),
  (numberOfSteps: 5, stepsRange: [1, 2]),
  (numberOfSteps: 5, stepsRange: [0, -2]),
